...
class CheckinsControllerTest < ActionController::TestCase
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post :create, checkin: { checkin_date: @checkin.checkin_date, status: @checkin.status, user_id: @checkin.user_id }
    end
  ...
  test "should update checkin" do
    put :update, id: @checkin, checkin: { checkin_date: @checkin.checkin_date, status: @checkin.status, user_id: @checkin.user_id }
    assert_redirected_to checkin_path(assigns(:checkin))
  end
